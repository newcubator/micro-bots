...
export const lockUnlockProjectErrorNoProjectId = () => {
    return responseTemplate('Du hast keine Projekt ID angegeben oder deine Projekt ID war ungültig. Versuche das Kommando noch einmal mit einer korrekten Projekt ID aufzurufen.');
};
