...
export const createCompletionNoticePdf = (project: MocoProject, contact: MocoContact): jsPDF => {
    ...
    doc
        ...
        .text(`hiermit zeigen wir Ihnen an, dass wir alle von uns im Projekt ${project.name} mit der Auftragsnummer ${project.custom_properties.Bestellnummer} zu erbringenden Leistungen erbracht haben.`, 68, 325, {
            maxWidth: 460
        })
