...
<table cellpadding="0" cellspacing="0" style="vertical-align: -webkit-baseline-middle; font-size: medium; font-family: Arial;">
  <tbody>
                  ...
                  <tbody>
                    <tr height="25" style="vertical-align: middle;">
                      ...
                      <td style="padding: 0px; color: rgb(80, 80, 94);">
                        <a href="tel:${user.custom_properties.Standort === "Dortmund" ? "+49 231 58687380" : "+49 511 95731300"}" color="#50505e" style="text-decoration: none; color: rgb(80, 80, 94); font-size: 12px;">
                          <span>${user.custom_properties.Standort === "Dortmund" ? "+49 231 58687380" : "+49 511 95731300"}</span>
                        </a>
                      </td>
                    </tr>
                    <tr height="25" style="vertical-align: middle;">
    ...
    <tr>
      <td>
        <a href="https://newcubator.com/email-marketing-banner" style="display: inline-block; padding: 0; width: 100%; background-color: rgba(255, 255, 255, 0);">
          <img src="https://newcubator.com/images/email-marketing-banner/email-footer-image.jpg" alt="newcubator banner" style="display: block; width: 100%;">
        </a>
      </td>
    </tr>
  </tbody>
